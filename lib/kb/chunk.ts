...
export const CHUNKING = {
  ...
  rationale: [
    ...
    "Cap each chunk near 900 characters (about 220 tokens) to stay inside MiniLM's effective window, so a single embedding is not asked to summarise an over-long passage.",
